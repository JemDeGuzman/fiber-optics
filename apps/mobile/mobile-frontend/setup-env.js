...
/**
 * Setup script for mobile frontend - detects local IP and updates .env
 */
const fs = require("fs");
const os = require("os");
...
try {
  ...
  console.log(`✓ Mobile frontend .env updated`);
  console.log(`  API URL: ${apiUrl}`);
} catch (err) {
  console.error(`✗ Failed to update mobile .env file:`, err.message);
  process.exit(1);
}
